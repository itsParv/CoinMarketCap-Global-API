...
active_currencies_string = '{:,}'.format(active_currencies)#TAKE active_currencies AS INPUT AS SEPRATE THEM BY ','
...
print('The global cap of all crypto is '  + global_cap_string + ' and the 24h global volume is ' + global_volume_string+'.')
print('bitcoin\'s total percentage of the global cap is ' + str(bitcoin_percentage) +'.')
print()
print('This information is last last_updated on ' + last_updated_string+ '.')#unix time stamp
